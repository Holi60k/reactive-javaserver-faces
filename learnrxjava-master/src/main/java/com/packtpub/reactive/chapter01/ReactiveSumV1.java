...
/**
 * A demonstration of how to implement a sum that updates automatically when any
 * of its collectors changes.
 *
 * @author meddle
 */
public class ReactiveSumV1 implements Program {
    ...
    /**
     * The sum is just an Observer, which subscribes to a stream created by
     * combining 'a' and 'b', via summing.
     *
     * @author meddle
     */
     ...
     * <varName> = <value> or <varName> : <value>. It emits the <value>.
     * @param varName
     */
    ...
    /**
     * Here the input is executed on a separate thread, so we block the current
     * one until it sends a `completed` notification.
     *
     * @param args
     */
